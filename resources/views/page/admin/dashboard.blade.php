...
@section('content-web')
    ...
    @if (session()->has('update-message'))
        <div class="fixed bottom-0 right-8 mb-3 z-99999">
            <div id="toast-success"
                ...
                <div class="ms-3 text-sm font-normal">{{ session()->get('update-message') }}</div>
                <button type="button"
                    class="ms-auto -mx-1.5 -my-1.5 bg-white text-gray-400 hover:text-gray-900 rounded-lg focus:ring-2 focus:ring-gray-300 p-1.5 hover:bg-gray-100 inline-flex items-center justify-center h-8 w-8 dark:text-gray-500 dark:hover:text-white dark:bg-gray-800 dark:hover:bg-gray-700"
    ...
    <div class="relative flex flex-1 flex-col overflow-y-auto overflow-x-hidden">
        ...
        <!-- ===== Main Content Start ===== -->
        <main>
            <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10 flex flex-col gap-8">
                <div class="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 lg:grid-cols-4 2xl:gap-7.5">
                    <!-- Card Item Start -->
                    <div
                        class="rounded-sm border border-stroke bg-box px-7.5 py-6 shadow-default dark:border-strokedark dark:bg-boxdark">
                        <div class="flex h-11.5 w-11.5 items-center justify-center rounded-full bg-meta-2 dark:bg-meta-4">
                            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="22" viewBox="0 0 2048 2048"
                                class="fill-primary dark:fill-white" fil="none">
                                <path fill=""
                                ...
                                @foreach ($users as $user)
                                    <tr>
                                        <td class="border-b border-[#eee] px-4 py-5 pl-9 dark:border-strokedark xl:pl-11">
                                            <h5 class="font-medium text-black dark:text-white">{{ $user->username }}</h5>
                                        </td>
                                        ...
                                        <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                                            <div class="flex items-center space-x-3.5">
                                                ...
                                                {{-- View Modal --}}
                                                <div id="view-modal-{{ $user->id }}" data-modal-backdrop="static"
                                                    tabindex="-1" aria-hidden="true"
                                                    class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                                                    <div class="relative p-4 w-full max-w-2xl max-h-full">
                                                        <!-- Modal content -->
                                                        <div
                                                            class="relative bg-gray-700 rounded-lg shadow dark:bg-gray-700">
                                                            <!-- Modal header -->
                                                            <div
                                                                ...
                                                                <button type="button"
                                                                    ...
                                                                    data-modal-hide="view-modal-{{ $user->id }}">
                                                            ...
                                                            <div
                                                                ...
                                                                <button data-modal-hide="view-modal-{{ $user->id }}"
                                                                    type="button"
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="p-4 md:p-5">
                                                                <form class="space-y-4"
                                                                    action="{{ route('register.update', $user->id) }}"
                                                                    method="POST">
                                                                    @csrf
                                                                    <div>
                                                                        <label for="username"
                                                                            class="block mb-2 text-sm font-medium dark:text-white">Your
                                                                            Username</label>
                                                ...
                                                <div id="delete-modal-{{ $user->id }}" tabindex="-1"
                                                    ...
                                                    <div class="relative p-4 w-full max-w-md max-h-full">
                                                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                                            ...
                                                            <form action="{{ route('register.delete', $user->id) }}"
                                                                method="POST">
                                                                @csrf
